...
public class MainWindow {
    ...
    public MainWindow() {
        ...
        final JMenuItem mntmOpen = new JMenuItem(new AbstractAction("Open") {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    log.info("[TODO] Adding images to database is not implemented yet");
                }
            }
        });
        ...
        final JMenuItem mntmSearchForFaceInDatabase = new JMenuItem(new AbstractAction("Search face") {
            ...
            public void actionPerformed(ActionEvent e) {
                if (faceToFindInDatabase == null) {
                    // TODO set progress bar to zero and display alert
            ...
            class DatabaseFaceSearcherSwingWorker extends SwingWorker<Void, Integer> {
                ...
                private void searchInDatabase() {
                    ...
                    List<ImageListCell> l = new ArrayList<>(imagesInAllFacesTab.size());
                    ...
                    publish(50);
                    BufferedImage face = faceToFindInDatabase.getImage();
                    int predictedLabel = eigenfaces.predictFaces(face);
                ...
                if (duringSearchingInDatabase) {
                    ...
                    if (c.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION) {
                        ...
                        try {
                            ...
                            log.warning("Error during reading " + fname + " image! Skipping. Details: "
        ...
        imagesInAllFacesTabJList = new JList<ImageListCell>(imagesInAllFacesTab);
        ...
        imagesInAllFacesTabJList.addListSelectionListener(new AllFacesListSelectionListener());
        ...
        final JScrollPane scrollPaneFindFaces = new JScrollPane(imagesInFindFacesTabJList);
    ...
    protected void addFaces(List<FaceEntity> allFaces) {
        log.info("Loaded face entities names:");
    ...
    private void setImageToFind(File img) throws IOException {
        ...
        ImageListCell cell = new ImageListCell(img);
        if (cell != null) {
