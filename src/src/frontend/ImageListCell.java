...
class ImageListCell extends JLabel {
    ...
    private final static int ICON_WIDTH = 180,
            ICON_HEIGHT = (int) (ICON_WIDTH * IMAGE_RATIO);
    ...
    public ImageListCell(int id, BufferedImage image, String filename,
            String fullPath) {
        super(Integer.toString(id) + ". " + filename,
                new ImageIcon(image.getScaledInstance(ICON_WIDTH, ICON_HEIGHT,
                        Image.SCALE_DEFAULT)),
                LEFT);
        this.id = id;
        this.image = image;
