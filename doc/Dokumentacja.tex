...
Najważniejszą biblioteką wykorzystaną w ramach projektu jest biblioteka implementująca \emph{PCA} i \emph{eigenfaces}, tj. biblioteka \emph{OpenCV Contrib Faces}, która została pobrana z oficjalnego repozytorium:
\begin{center}
...
\begin{center}
\texttt{DD-MM-YYYY\_HH-MM-SS.log}
\end{center}
gdzie:
\begin{itemize}
