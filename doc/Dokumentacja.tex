...
Do rozpoznawania twarzy zostanie zastosowana \emph{metoda analizy głównych składowych}~(ang.~\emph{Principal Component Analysis} -- w~skrócie:~PCA). Poniżej przedstawiono opis tej metody na podstawie publikacji autorów metody \emph{eigenfaces}, tzn. profesorów:~\emph{Matthew Turk'a} i \emph{Alex'a Pentland'a}\cite{turk}.
...
Aplikację zaimplementowano w języku \emph{Java}, korzystajac ze środowiska graficznego \emph{Swing}. Preprocessing zdjęć twarzy został napisany w języku skryptowym \emph{Python}.
